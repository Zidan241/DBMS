...
public class RTree<K extends Comparable<? super K>, V> implements Serializable {
	...
	public RTree(String tableName, String columnName, int IndexNum) {
		this(DEFAULT_BRANCHING_FACTOR, tableName, columnName, IndexNum);
	}

	public RTree(int branchingFactor, String tableName, String columnName, int IndexNum) {
	...
	abstract class Node implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2364930435821988299L;
		/**
		 * 
		 */
		/**
	...
	class InternalNode extends Node implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3004779019690249299L;
		/**
		 * 
		 */
		/**
	...
	class LeafNode extends Node implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4473803118529935616L;
		/**
		 * 
		 */
		/**
